...
from verifyn.agent.db import Base, _get_engine, find_similar_queries, get_query_history
from verifyn.agent.models import FactCheckResult
...
class TestSimilarityPipeline:
    ...
    def test_02_identical_query_found_in_similarity_search(self):
        ...
        from verifyn.agent.db import compute_embedding

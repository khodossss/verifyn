...
from agent.db import Base, _get_engine, save_query
...
class TestSimilaritySearchIntegration:
    ...
    @patch("agent.db.compute_embedding", return_value=FAKE_EMBEDDING)
    ...
    def test_stream_variant_calls_similarity_tool(self, mock_embed):
        ...
        from agent.agent import analyze_news_stream
